...
export const CURRENT_PROJECTS: CaseStudyFull[] = [
  {
    ...
    tagline: "12x faster than legacy AutoCAD workflows",
    industry: "Construction & Engineering",
    description: "End-to-end AI platform that extracts mechanical diagrams from floor plans, analyses specifications, maps duct systems, and generates automated estimation reports.",
    domain: "Construction Technology, HVAC Engineering",
    role: "Product Design Lead",
    scope: "AI Platform, Diagram Extraction, Estimation Engine, Report Generation",
    challenge: "HVAC estimation was a manual, error-prone process relying on AutoCAD and spreadsheets. Engineers spent days cross-referencing floor plans with duct specifications, manually calculating material requirements, and generating reports. The process couldn't scale and was a bottleneck for project timelines across the construction pipeline.",
    whyItMattered: "Every day of estimation delay cascades through the entire construction timeline. Faster, more accurate estimates mean faster project starts, fewer change orders, and lower costs. The opportunity was to replace an entire legacy workflow with AI-driven automation.",
    approach: [
      { title: "Floor Plan Intelligence", detail: "Designed the AI pipeline that extracts mechanical diagrams from architectural floor plans automatically. The system identifies duct layouts, HVAC equipment placement, and spatial relationships without manual tracing." },
      { title: "Specification Mapping", detail: "Built an intelligent specification matching engine that cross-references extracted components against a catalog of HVAC equipment and materials, automatically mapping the right specs to the right components." },
      { title: "Automated Estimation Engine", detail: "Designed the end-to-end estimation workflow — from extracted data to material quantities, labor estimates, and cost calculations. What took days now happens in minutes with higher accuracy." },
      { title: "Report Generation", detail: "Created comprehensive, client-ready estimation reports with detailed breakdowns, visual annotations on floor plans, and exportable formats for project stakeholders." },
    ],
    outcomes: [
      { metric: "12x", detail: "Faster estimation output compared to legacy AutoCAD workflows" },
      { metric: "Full", detail: "AutoCAD replacement for estimation workflows" },
      { metric: "AI", detail: "Catalog matching for automated material specification" },
      { metric: "Zero", detail: "Manual floor plan tracing required" },
    ],
    category: "current",
  },
  {
